        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
          <form @submit.prevent="guardarRegla">
            ...
            <div class="mb-6">
              ...
              <p v-if="errors.usuario_id" class="text-red-500 text-sm mt-1">{{ errors.usuario_id[0] }}</p>
            </div>
            ...
            <div class="mb-6">
              ...
              <p v-if="errors.tipo_limite" class="text-red-500 text-sm mt-1">{{ errors.tipo_limite[0] }}</p>
            </div>
            ...
            <div class="mb-6">
              ...
              />
              <p v-if="errors.monto_limite" class="text-red-500 text-sm mt-1">{{ errors.monto_limite[0] }}</p>
            </div>
            ...
            <div class="mb-6">
              ...
              <p class="text-xs text-gray-500 mt-1">Si dejas en blanco, la regla aplica a todos los módulos</p>
            </div>
            ...
            <div class="mb-6">
              <label class="flex items-center">
                ...
                />
                <span class="ml-2 text-sm text-gray-700">Regla activa</span>
              </label>
            </div>
            ...
            <div class="flex gap-4">
              <button 
                ...
                :disabled="loading"
              >
                {{ loading ? 'Guardando...' : (regla ? 'Actualizar' : 'Crear') }} Regla
              </button>
              <a 
...
async function guardarRegla() {
  ...
  try {
    if (props.regla) {
      // Actualizar
      await axios.put(`/api/admin/monedero/reglas/${props.regla.id}`, form.value);
    } else {
      // Crear
