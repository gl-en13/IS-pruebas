...
<div class="mb-6">
    <p class="text-sm text-gray-500"><?php echo e(now()->isoFormat('dddd, D [de] MMMM')); ?></p>
    <h1 class="text-2xl font-bold text-gray-900">¡Hola, <?php echo e(explode(' ', $user->name)[0]); ?>! 👋</h1>
</div>
...
<div class="balance-card mb-6">
    <div class="relative z-10">
        ...
        <p class="text-4xl font-bold mb-4">$<?php echo e(number_format($wallet->balance, 2)); ?></p>

        <div class="flex items-center justify-between">
            <div>
                <p class="text-blue-200 text-xs">Tarjeta</p>
                <p class="text-white font-mono text-sm tracking-widest">**** **** **** <?php echo e(substr($wallet->card_number, -4)); ?></p>
            </div>
            <div class="text-right">
                <p class="text-blue-200 text-xs">Límite mensual</p>
                <p class="text-white text-sm font-semibold">$<?php echo e(number_format($wallet->monthly_limit, 2)); ?></p>
            </div>
        </div>
    </div>
</div>
...
<div class="grid grid-cols-4 gap-3 mb-6">
    <a href="<?php echo e(route('recharge.index')); ?>" class="flex flex-col items-center gap-2 p-3 bg-white rounded-xl border border-slate-100 hover:shadow-md transition-all text-center">
    ...
    <a href="<?php echo e(route('movements.index')); ?>" class="flex flex-col items-center gap-2 p-3 bg-white rounded-xl border border-slate-100 hover:shadow-md transition-all text-center">
    ...
    <a href="<?php echo e(route('wallet.index')); ?>" class="flex flex-col items-center gap-2 p-3 bg-white rounded-xl border border-slate-100 hover:shadow-md transition-all text-center">
    ...
    <a href="<?php echo e(route('support.index')); ?>" class="flex flex-col items-center gap-2 p-3 bg-white rounded-xl border border-slate-100 hover:shadow-md transition-all text-center">
...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
    <div class="card p-4 flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-xl font-bold text-gray-900">$<?php echo e(number_format($monthlyCargos, 2)); ?></p>
        </div>
    </div>
    ...
    <div class="card p-4 flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-xl font-bold text-gray-900">$<?php echo e(number_format($monthlyAbonos, 2)); ?></p>
        </div>
    </div>
</div>
...
<div class="card">
    <div class="flex items-center justify-between px-5 pt-5 pb-3 border-b border-slate-50">
        ...
        <a href="<?php echo e(route('movements.index')); ?>" class="text-sm text-blue-600 hover:text-blue-700 font-medium">Ver todos</a>
    </div>
    ...
    <div class="divide-y divide-slate-50">
        ...
        <div class="flex items-center justify-between px-5 py-3.5 hover:bg-slate-50 transition-colors">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400"><?php echo e($tx->formatted_date); ?> · <?php echo e($tx->reference); ?></p>
                </div>
            </div>
            <div class="text-right">
                <p class="text-sm font-semibold <?php echo e($tx->type === 'abono' ? 'text-green-600' : 'text-gray-900'); ?>">
                    <?php echo e($tx->type === 'abono' ? '+' : '-'); ?>$<?php echo e(number_format($tx->amount, 2)); ?>

                </p>
                <span class="badge-<?php echo e($tx->type === 'abono' ? 'green' : 'blue'); ?> text-xs">
        ...
        <div class="px-5 py-10 text-center">
            ...
            <a href="<?php echo e(route('recharge.index')); ?>" class="mt-2 inline-block text-blue-600 text-sm font-medium">Haz tu primera recarga →</a>
        </div>
        <?php endif; ?>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel-dashboard\resources\views/student/home.blade.php ENDPATH**/ ?>