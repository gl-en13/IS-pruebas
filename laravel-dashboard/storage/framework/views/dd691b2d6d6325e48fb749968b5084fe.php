...
<head>
    ...
    <title><?php echo e(config('app.name')); ?> — <?php echo $__env->yieldContent('title', 'Acceso'); ?></title>
...
<body class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-slate-50 flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="flex flex-col items-center mb-8">
            ...
            <p class="text-sm text-gray-500 mt-1"><?php echo $__env->yieldContent('subtitle'); ?></p>
        </div>
            ...
            <div class="mb-5 p-3.5 bg-red-50 border border-red-200 rounded-xl">
                <ul class="text-sm text-red-700 space-y-1">
                    ...
                    <li class="flex items-start gap-2">
                        <span class="mt-0.5">•</span> <?php echo e($error); ?>
...
<?php /**PATH C:\xampp\htdocs\laravel-dashboard\resources\views/layouts/auth.blade.php ENDPATH**/ ?>