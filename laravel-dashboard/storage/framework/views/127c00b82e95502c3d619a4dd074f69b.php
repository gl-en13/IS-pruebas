...
<head>
    ...
    <title><?php echo e(config('app.name', 'Monedero Universitario')); ?></title>
...
<body class="h-full">
    ...
    <aside class="sidebar">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            ...
            <a href="<?php echo e(route('recharge.index')); ?>" class="nav-item <?php echo e(request()->routeIs('recharge.*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
                Recargar
            </a>

            <a href="<?php echo e(route('movements.index')); ?>" class="nav-item <?php echo e(request()->routeIs('movements.*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
                Movimientos
            </a>

            <a href="<?php echo e(route('wallet.index')); ?>" class="nav-item <?php echo e(request()->routeIs('wallet.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('profile.index')); ?>" class="nav-item <?php echo e(request()->routeIs('profile.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('support.index')); ?>" class="nav-item <?php echo e(request()->routeIs('support.*') ? 'active' : ''); ?>">
        ...
        <div class="px-3 py-4 border-t border-slate-100">
            <div class="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-gray-50 transition-colors">
                <div class="avatar text-sm"><?php echo e(substr(Auth::user()->name, 0, 1)); ?><?php echo e((strpos(Auth::user()->name, ' ') !== false ? substr(Auth::user()->name, strpos(Auth::user()->name, ' ') + 1, 1) : '')); ?></div>
                <div class="min-w-0 flex-1">
                    <p class="text-sm font-semibold text-gray-900 truncate"><?php echo e(Auth::user()->name); ?></p>
                    <p class="text-xs text-gray-400 truncate"><?php echo e(Auth::user()->student_id); ?></p>
                </div>
    ...
    <nav class="mobile-nav">
        ...
        <a href="<?php echo e(route('recharge.index')); ?>" class="mobile-nav-item <?php echo e(request()->routeIs('recharge.*') ? 'active' : ''); ?>">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
            Recargar
        </a>
        <a href="<?php echo e(route('movements.index')); ?>" class="mobile-nav-item <?php echo e(request()->routeIs('movements.*') ? 'active' : ''); ?>">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
            Historial
        </a>
        <a href="<?php echo e(route('wallet.index')); ?>" class="mobile-nav-item <?php echo e(request()->routeIs('wallet.*') ? 'active' : ''); ?>">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/></svg>
            Monedero
        </a>
        <a href="<?php echo e(route('profile.index')); ?>" class="mobile-nav-item <?php echo e(request()->routeIs('profile.*') ? 'active' : ''); ?>">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
            Config
        </a>
    </nav>
...
<?php /**PATH C:\xampp\htdocs\laravel-dashboard\resources\views/layouts/app.blade.php ENDPATH**/ ?>